...
5. Once you're sure you're done using the database and won't be querying it again, you can drop the database using the command `DROP DATABASE stackoverflow_com;`, then [purge binary logs](https://dev.mysql.com/doc/refman/8.0/en/purge-binary-logs.html) to get your 1TB of storage back. You can always re-run the import script if you change your mind.
