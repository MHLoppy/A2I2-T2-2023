...
5. Once you're sure you're done using the database and won't be querying it again, you use the command `DROP DATABASE stackoverflow_com;` to get your 1TB of storage back. You can always re-run the import script if you change your mind.
